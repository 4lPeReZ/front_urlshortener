...
const Header = ({ isLoggedIn, user, setIsLoggedIn, setUser }) => {
  ...
  return (
    <header className="bg-transparent text-white py-4 px-6 md:px-8 fixed top-0 left-0 right-0 z-10 flex justify-between items-center w-full">
      ...
      <nav aria-label="Main navigation" className="flex items-center">
        {isLoggedIn ? (
          ...
          <div className="flex items-center space-x-4">
          <Link to="/login" className="bg-gray-800 hover:bg-gray-700 text-white py-2 px-4 rounded-full shadow-md transition duration-300 flex items-center">
            Login
